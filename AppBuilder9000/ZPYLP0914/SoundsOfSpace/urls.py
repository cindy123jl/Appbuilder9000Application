...
urlpatterns = [
    ...
    path('SOS_PlanetDetail/<int:id>/PlanetEdit', views.PlanetEdit, name='PlanetEdit'),
    path('SOS_PlanetDetail/<int:id>/PlanetDelete', views.PlanetDelete, name='PlanetDelete')
]
